...
## User Interaction
- Present review findings and improvement suggestions for user feedback
- Ask for user approval before saving the final formatted document
...
- Present findings and ask for user approval before making changes
