...
## User Interaction
Run analysis without approval (non-destructive). Ask for user approval before generating tutorial files.
...
You MUST read and apply: `templates/technical-writer/step-by-step-tutorial-template.md`

**Core Logic**: Execute following requirements
- Generate tutorial using template structure exactly
