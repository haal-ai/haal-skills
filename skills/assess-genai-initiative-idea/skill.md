...
2. Create `[staging_dir]/genai-assessments/[initiative_name]-data.md` file with structured responses
3. Present to user for review and sign-off
4. Analyze responses for ambiguities, generic information, or gaps5. Rate issues as Critical, Important, or Suggestion
5. If critical issues found, request clarification before proceeding
...
1. Summarize key points from validated responses2. Search web for similar initiatives across multiple platforms:
   - GitHub repositories
   - Medium articles
   - Reddit discussions
   - Industry publications
   - Academic papers (up to 5 total sources)
3. Document alternatives and challenges in `[staging_dir]/genai-assessments/[initiative_name]-data.md`
4. Identify implementation challenges (technical, organizational, ethical)
5. Challenge the proposal with alternative approaches6. Request user justification for rejecting alternatives
...
- Primary deliverable: `[staging_dir]/genai-assessments/[initiative_name]-data.md` with structured chapters:
  - Initiative Overview
  - Questionnaire Responses
  - Alternatives and Challenges
  - Implementation Challenges
  - Conclusion and Recommendations
- Supporting documentation: Research sources and validation notes in `[staging_dir]/genai-assessments/`
...
### Completion Summary
- Summary of initiative assessment with key staging
...
- Rule 5: You MUST document all staging in structured format
...
## Required Actions
1. Validate user readiness and assessment scope definition2. Execute structured questionnaire collection with quality review
3. Generate comprehensive research across multiple platforms4. Provide challenge analysis and alternative solution evaluation
...
- MANDATORY: Ask for user approval before major phase transitions
...
- ALWAYS document staging in structured format with clear chapters
