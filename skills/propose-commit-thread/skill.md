...
## User Interaction
- Always ask for user approval before executing commits (permanent git history impact)
...
- Rule 1: **NEVER execute commits without explicit user approval**
...
- MANDATORY: Always ask for user approval before executing commits
