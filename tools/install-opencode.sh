...
echo "=== Setup Complete ==="
echo ""
echo "You're ready! Type:"
echo ""
echo "  opencode"
echo ""
echo "On first launch, select 'GitHub Copilot' and log in with your GitHub credentials."
echo "Shortcut: type 'occ' to go straight to the login screen."
