...
You MUST pay special attention to [olaf-general-role-and-behavior] - Expert domain approach.
You MUST apply [olaf-interaction-protocols] - Appropriate execution protocol.
...
### 4. Core Logic
Execute following protocol requirements:
...
## Critical Requirements1. MANDATORY: Follow Propose-Act protocol for all report generation and modifications
