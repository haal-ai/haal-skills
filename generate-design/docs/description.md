...
Generate Design is a master coordinator skill that transforms an EARS specification into a layered system design. It executes a 5-task chain using the Propose-Act protocol to analyze specifications, identify application types, design layer architecture, create task breakdowns, and generate comprehensive design documents.
...
- Propose-Act gate for user approval
...
3. **Approve architecture early**: Use the Propose-Act gate to confirm direction
