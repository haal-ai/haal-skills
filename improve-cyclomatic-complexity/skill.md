...
- Treat the **Evolution/Refactoring Mode** as default:
  ...
  - Focus on internal refactors to reduce complexity: SRP, DI for externals,
    smaller functions, clearer control flow, better naming.
- Only when the user explicitly requests a redesign or new module, consider
  **Creation/New Code Mode** and ensure any proposed changes are clearly
  separated from pure refactoring steps.
...
Use template: `templates/complexity-reduction-report-template.md`

The report should include:
- Current complexity assessment with decision point breakdown
- Control flow visualization
- Test coverage evaluation
- Root cause analysis of complexity patterns
- Phased refactoring strategy
- Refactored implementation with supporting classes/methods
- Verification results and metrics comparison
