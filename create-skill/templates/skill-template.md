...
### 2. Execution Phase
You MUST execute these operations as needed:
...
**OUTPUT LOCATION**: All files generated by this skill MUST be placed in `.olaf/work/<skill-specific-folder>` unless user specifies otherwise.

**USER INTERACTION**: When presenting choices or requesting information from user, ALWAYS use numbered lists to facilitate responses.
