...
### Shell & Platform
- **Shell**: Bash 4.0+ (Linux)
- **Platform**: Linux environment assumed

### Development Tools
- **JDK Location**: `$HOME/.olaf/jdk`
- **Python**: 3.12 or higher (for new scripts)
- **Script Preference**: Python scripts preferred over bash/zsh scripts

### User-Specific Paths
- **User Profile**: `$HOME` (Linux-specific)
- **OLAF Tools Directory**: `$HOME/.olaf/`

### Package Management
- **System Package Manager**: apt/yum/dnf (distribution-specific)
...
## Notes
This file contains Linux bash-specific configurations.
