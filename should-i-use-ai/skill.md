...
## Core Logic
1. **Analyze the task** against the LLM vs IDE categorization guide located in #[[file:kb/llm-vs-ide-task-guide.md]]
2. **Categorize** into LLM or IDE tool recommendation3. **Provide specific guidance** based on recommendation
