...
For each task, the skill follows the Propose-Confirm-Act protocol:

1. **Propose**: The skill summarizes the task objective, expected outputs, and success criteria
2. **Confirm**: You review and approve the task execution
3. **Act**: The skill performs the task (code changes, file edits, tests)
