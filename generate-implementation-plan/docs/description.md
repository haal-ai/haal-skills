...
Generate Implementation Plan transforms a specification and system design into a detailed, executable implementation task plan with requirement traceability and optional bootstrap integration. It executes a 7-task chain using the Propose-Act protocol.
